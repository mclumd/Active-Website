...
\begin{displaymath}C + U = C \cap [[U]] \end{displaymath}%
\lthtmldisplayZ
\hfill\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmldisplayA{displaymath185}%
\begin{displaymath}C + (not U) = C \setminus (C + U) \end{displaymath}%
\lthtmldisplayZ
\hfill\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmldisplayA{displaymath186}%
\begin{displaymath}C + (if U then V) = C \setminus ((C + U) \setminus ((C + U) + V))
\end{displaymath}%
\lthtmldisplayZ
\hfill\lthtmlcheckvsize\clearpage}
...
$\exists x~y~ Roses(x) \wedge Fridge(y)
\wedge In(x, y)$%
\lthtmlinlinemathZ
\hfill\lthtmlcheckvsize\clearpage}
